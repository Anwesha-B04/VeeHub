...
export default function ListingCard({listing, onSelect, selected, user}){
  let img = '/hero.jpg';
      ...
      <div className="card-body p-4">
        ...
        <div className="flex items-center gap-3 mt-3">
          ...
          {user && user.role === 'seller' && (
            <Link className="btn btn-primary inline-flex items-center px-3 py-2 rounded-md" to={`/buyer/listing/${listing._id}?openMessages=1`}>Messages</Link>
          )}
        </div>
      </div>
    </div>
